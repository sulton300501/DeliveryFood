...
urlpatterns = [
    path("main/PostCategory/Food/", views.CategoryFoodAPIView.as_view()),
    path("main/GetAllCategory/Food", views.CategoryFoodAllView.as_view()),
    path("main/PostMediaFile/Food/", views.MediaFileView.as_view()),
    path("main/GetAllMediaFile/Food", views.MediaFileALLView.as_view()),
    path("main/PostPromo/Food", views.PromoView.as_view()),
    path("main/GetAllPromo/Food", views.PromoAllView.as_view()),
